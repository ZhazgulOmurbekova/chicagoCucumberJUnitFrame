...
public class TeacherAPI {
    ...
    public void emailValidation() throws Exception{
        ...
        Assert.assertEquals("List of teachers API faild", 200,response.statusCode());
...
//        teacher.setEmailAddress("ja.2020@gmail.com");
//        teacher.setFirstName("aa");
//        teacher.setLastName("Lastname");
//        teacher.setJoinDate("10/11/2034");
//        teacher.setSalary(3000);
//        teacher.setBatch(14);
//        teacher.setBirthDate("12/12/2034");
//        teacher.setGender("male");
//        teacher.setPassword("123456");
//        teacher.setPermanentAddress("main st");
//        teacher.setSection("fghjk");
//        teacher.setSubject("math");
//        teacher.setDepartment("Sports");
//        teacher.setPhone("3123456789");
//        //teacher.setAddress("main street");
//       // teacher.set
//
//        ObjectMapper objectMapper = new ObjectMapper();
